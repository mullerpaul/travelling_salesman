  WITH hamiltonian_paths -- one row per path
    AS (SELECT ROWNUM AS path_id,
               ...
               n9.node_id as n9,
               n10.node_id as n10,
               n1.node_id as n11  --repeat the start node here to make the next step easier
          FROM node n1, node n2, node n3, node n4, node n5, node n6, node n7, node n8, node n9, node n10
         WHERE n1.node_id <> n2.node_id AND n1.node_id <> n3.node_id AND n1.node_id <> n4.node_id AND n1.node_id <> n5.node_id AND n1.node_id <> n6.node_id 
           AND n1.node_id <> n7.node_id AND n1.node_id <> n8.node_id AND n1.node_id <> n9.node_id AND n1.node_id <> n10.node_id
           ...
           AND n2.node_id <> n8.node_id AND n2.node_id <> n9.node_id AND n2.node_id <> n10.node_id
           ...
           AND n3.node_id <> n9.node_id AND n3.node_id <> n10.node_id
           AND n4.node_id <> n5.node_id AND n4.node_id <> n6.node_id AND n4.node_id <> n7.node_id AND n4.node_id <> n8.node_id AND n4.node_id <> n9.node_id
           AND n4.node_id <> n10.node_id
           AND n5.node_id <> n6.node_id AND n5.node_id <> n7.node_id AND n5.node_id <> n8.node_id AND n5.node_id <> n9.node_id AND n5.node_id <> n10.node_id
           AND n6.node_id <> n7.node_id AND n6.node_id <> n8.node_id AND n6.node_id <> n9.node_id AND n6.node_id <> n10.node_id 
           AND n7.node_id <> n8.node_id AND n7.node_id <> n9.node_id AND n7.node_id <> n10.node_id
           AND n8.node_id <> n9.node_id AND n8.node_id <> n10.node_id
           AND n9.node_id <> n10.node_id
           AND n1.node_id = 1),
...
-- 10 cities completed in 12.3 sec
-- 10 cities completed in 11.9
