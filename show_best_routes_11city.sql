  WITH hamiltonian_paths -- one row per path
    AS (SELECT ROWNUM AS path_id,
               ...
               n10.node_id as n10,
               n11.node_id as n11,
               n1.node_id as n12  --repeat the start node here to make the next step easier
         ...
         WHERE n1.node_id <> n2.node_id AND n1.node_id <> n3.node_id AND n1.node_id <> n4.node_id AND n1.node_id <> n5.node_id AND n1.node_id <> n6.node_id 
           ...
           AND n2.node_id <> n8.node_id AND n2.node_id <> n9.node_id AND n2.node_id <> n10.node_id AND n2.node_id <> n11.node_id
...
-- 11 cities - 1 minute 17 sec (77sec)
-- 11 cities - 1 minute 10 sec (70sec)
